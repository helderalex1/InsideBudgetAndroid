package com.example.InsideBudget.Adapter.Users;
...
public class ListaTodosProdutosAdapter extends BaseAdapter {

    private Context context;
    private LayoutInflater layoutInflater;
    private ArrayList<Produto> todosProdutos;

    public ListaTodosProdutosAdapter(Context context, ArrayList<Produto> todosProdutos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListaTodosProdutosAdapter.ViewHolderLista viewHolderLista = (ListaTodosProdutosAdapter.ViewHolderLista) convertView.getTag();
        if(viewHolderLista == null){
            viewHolderLista = new ListaTodosProdutosAdapter.ViewHolderLista(convertView);
